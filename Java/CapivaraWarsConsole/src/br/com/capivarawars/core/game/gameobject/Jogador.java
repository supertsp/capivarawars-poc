...
public class Jogador extends GameObject{
    ...
    public Jogador(String nick, Capivara novaCapivara, int tamanhoRio, Canoa novaCanoa) {
        super(Jogador.class);
        this.nick = nick;
    ...
    public Jogador(String nick, Capivara novaCapivara, int tamanhoRio, int tamanhoCanoa){
        this(nick, novaCapivara, tamanhoRio, new Canoa("Vermelha", CorPadrao.VERMELHO, tamanhoCanoa));
    }
    //</editor-fold>
